...
public class HeroStatsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvStrength.setText(hero.getName());
        tvStrength.setText("Strength: "+ hero.getStrength());
        tvTechnicalProwess.setText("Technical: "+ hero.getTechnicalProwess());

        // When button Like is clicked, set the results accordingly and finish() to close this activity.
        ...
        btnDislike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Set result to RESULT_OK to indicate normal response and pass in the intent containing the dislike
                setResult(RESULT_OK, i);
                finish();
            }
        });
